...
let strings = new LocalizedStrings({
  en:{
    ...
    locationTypeTip1: '*Office locations receive vase arrangements, please put your vase in your office pantry, and place a card under the vase that identifies the recipient.',
  ...
  ch: {
    ...
    locationTypeTip1: '*辦公室地點會以到場插花的形式配送，請將花瓶放在茶水間，並在花瓶下用紙寫上收花人名稱。',
