...
let strings = new LocalizedStrings({
  en:{
    ...
    priceTip: 'Price should be an integer value greater or equal to 40. (e.g. 300)',
        ...
        if (data.uid === this.state.userID) {
          ...
          base.push(`arrangementsList`, {
            data: {
                ...
                price7Off: Math.floor(Number(price)*0.93),
