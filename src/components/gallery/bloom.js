...
let strings = new LocalizedStrings({
    en:{
      ...
      li5: "For the Elegant plan, the ideal vase height is 12-17cm and the ideal vase opening's diameter is 4-5cm.",
    ...
    ch: {
      ...
      li5: '建議花瓶尺寸:「盛會」計劃的設計配以一個 12-17cm 高，開口直徑 4-5cm 大的花瓶效果會較好。',
