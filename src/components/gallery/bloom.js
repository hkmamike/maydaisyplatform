...
let strings = new LocalizedStrings({
    ...
    ch: {
      ...
      noteOn: '計劃須知: ',
      planName: '盛會',
      li1: '"盛會"是一個由本地花匠籌劃，每週一次的花卉設計和配送服務。',
      li2: '我們的花匠會用時令花材設計您的花卉。"盛會"的設計雖然每週不同，但一般會有5-10朵主花配以適合的配花。',
      li3: '辦公室地點會以花束配送，而住家和墓園地點會以到場插花的形式配送。',
      li4: '如果您訂購了到場插花的服務，請將花瓶放在一個花匠可以到達的地方。以住家地點為例，如果配送當天家中沒有人，請將花瓶放在門前一個安全的位置。',
      li5: '建議花瓶尺寸: "優雅"的設計配以一個 12-17cm 高，開口直徑 3-4cm 大的花瓶效果會最好。',
        ...
        <Grid>
            <Row className="show-grid gallery-nav">
                ...
                <Col xs={12} className="nav-margin">
                        <Link to="/gallery-simple"><div>{strings.simple}</div></Link>
