...
let strings = new LocalizedStrings({
    en:{
      ...
      li5: "For the Classic plan, the ideal vase height is 10-15cm and the ideal vase opening's diameter is 1-2cm.",
    ...
    ch: {
      ...
      li5: '建議花瓶尺寸:「經典」計劃的設計配以一個 10-15cm 高，開口直徑 1-2cm 大的花瓶效果會較好。',
