...
let strings = new LocalizedStrings({
    en:{
      ...
      li6: "For the Classic plan, the ideal vase height is 10-15cm and the ideal vase opening's diameter is 2-4cm.",
    ...
    ch: {
      ...
      li6: '建議花瓶尺寸:「經典」計劃的設計配以一個 10-15cm 高，開口直徑 2-4cm 大的花瓶效果會較好。',
